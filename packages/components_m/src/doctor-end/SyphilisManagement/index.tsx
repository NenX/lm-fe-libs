...
import { MyForm, getFormData, } from '../../MyForm/index';
import './index.less';
import { IMchc_FormDescriptions_Field, SMchc_SyphilisManage } from '@lm_fe/service';
import { otherOptions } from '@lm_fe/env';
export class SyphilisManagement extends Component {
  state = {
    formHandler: {},
    syphilisData: {},
  };
  ...
  async componentDidMount() {
    ...
    let syphilisList = await SMchc_SyphilisManage.getList(get(pregnancyData, 'id'));
    const syphilisData = syphilisList[0] || {};
