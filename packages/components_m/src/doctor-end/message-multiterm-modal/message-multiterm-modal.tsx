import { Button, Empty, Menu, Modal, Tabs, Tree } from 'antd';
import { cloneDeep, filter, find, get, map, set, size } from 'lodash';
    ...
    if (level == '9' || level == '9read') {
      return (
        <div className="disposition">
          <span>{get(obj, `handleTime`)?.format( 'YY-MM-DD')}</span>
