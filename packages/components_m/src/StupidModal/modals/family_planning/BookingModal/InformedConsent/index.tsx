...
import CaseTempleteEdit from '@/components/GeneralComponents/CaseTemplete';
import { deleteResourcesByID } from '../../utils/defaultMethod';
import './index.less';
const signStates = [
  { label: '已签', value: '1' },
  { label: '拒签', value: '2' },
    ...
    for (const item of result) {
      if (item) {
        ...
        if (itemNameSplits.length === 2) {
          ...
          const dictionary = get(dictionaries, itemNameSplits[1]);
          const options = get(dictionary, 'enumerations');
