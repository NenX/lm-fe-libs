import { IFischerdata } from "../types";
import { getValue, inRange, isModified } from "./utils";
export function Fischer(_data: IFischerdata) {
    const fischerdata: IFischerdata = JSON.parse(JSON.stringify(_data))
