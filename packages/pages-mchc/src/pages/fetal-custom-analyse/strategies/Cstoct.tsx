import { ICstoctdata, _ctg_exams_analyse } from "../types";
import { getValue, isModified } from "./utils";
export function Cstoct(_data: ICstoctdata,) {
    const cstoctdata: ICstoctdata = JSON.parse(JSON.stringify(_data))
    if (!cstoctdata) return
